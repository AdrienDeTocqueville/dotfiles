...
nnoremap <C-f> :call fzf#run({'source': "git ls-files -- . ':!:*.meta' ':!:*.md' ':!:*.xml' ':!:*.asset' ':!:*.png'", 'sink': 'e', 'top': '40%', 'options': '-e'})<CR>
nnoremap <C-g> :Ag 
...
let gutentags_ctags_exclude+=['.yamato', '.github', 'LocalTestProjects', 'TestProjects', 'Tools', 'Samples~', 'Documentation~', '*.Migration.cs', 'Documentation', 'Packages', 'artifacts', 'build']
